...
let app = new Vue({
  el: "#vue",
  data: {
    thingName: "lee-square-mail", //Dweet Thing name
    buttonText: "Go!",
    status: "Idle",
  ...
  methods: {
    ...
    updateData: function(data) {
      if (data.status != undefined) this.dweet.status = data.status;
     // if (data.humidity != undefined) this.dweet.humidity= data.humidity;
     // if (data.alarm != undefined) this.dweet.alarm= data.alarm;
